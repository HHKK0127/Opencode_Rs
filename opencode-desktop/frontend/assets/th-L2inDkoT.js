...
;
{
  try {
    (function() {
      ...
      n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "8b7a3dc7-dd87-4296-a5da-194db0deb220", e._sentryDebugIdIdentifier = "sentry-dbid-8b7a3dc7-dd87-4296-a5da-194db0deb220");
    })();
  } catch (e) {
  }
}
...
const dict = {
  ...
  "provider.connect.oauth.code.visit.suffix": " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OpenCode",
...
//# sourceMappingURL=th-L2inDkoT.js.map
