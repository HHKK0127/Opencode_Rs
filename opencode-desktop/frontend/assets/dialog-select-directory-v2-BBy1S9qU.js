!(function() {
  try {
    var e2 = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
    e2.SENTRY_RELEASE = { id: "desktop@1.17.11" };
  } catch (e3) {
  }
})();
;
{
  try {
    (function() {
      var e2 = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {}, n2 = new e2.Error().stack;
      n2 && (e2._sentryDebugIds = e2._sentryDebugIds || {}, e2._sentryDebugIds[n2] = "2aea81c9-403d-47c1-985e-439b9360f7c4", e2._sentryDebugIdIdentifier = "sentry-dbid-2aea81c9-403d-47c1-985e-439b9360f7c4");
    })();
  } catch (e2) {
  }
}
;
import { bv as useGlobal, br as useDialog, bw as useLanguage, b1 as pickerMode, at as createSignal, am as createMemo, ap as createResource, ab as cleanPickerInput, aB as displayPickerPath, b0 as pickerFileSearchQuery, a0 as absoluteTreePath, ax as currentPickerSuggestions, aZ as onMount, aY as onCleanup, ag as createEffect, ad as createComponent, aL as insert, Y as TextInputV2, aP as memo, a as ButtonV2, b3 as pickerRoot, b2 as pickerParent, O as Show, h as For, ao as createRenderEffect, bc as setAttribute, aX as nextTreeScrollTop, c as DialogFooter, bn as use, b as Dialog, af as createDirectorySearch, a3 as advanceTreePreload, b6 as preloadTreeDirectories, a$ as pickerAbsoluteInput, a2 as activeTreeNavigation, bh as template, an as createPriorityTaskQueue, aW as nextSuggestionIndex, az as delegateEvents } from "./main-D_cwiNV1.js";
...
var _tmpl$ = /* @__PURE__ */ template(`<div id=directory-picker-v2-suggestions role=listbox class=directory-picker-v2-suggestions>`), _tmpl$2 = /* @__PURE__ */ template(`<div class=directory-picker-v2-state>`), _tmpl$3 = /* @__PURE__ */ template(`<div class=directory-picker-v2-body><div class=directory-picker-v2-path><div class=directory-picker-v2-actions></div></div><div class=directory-picker-v2-browser></div><div class=directory-picker-v2-selection>`), _tmpl$4 = /* @__PURE__ */ template(`<button role=option>`);
function DialogSelectDirectoryV2(props) {
  const global2 = useGlobal();
  const {
    sync,
    sdk
  } = global2.ensureServerCtx(props.server);
  ...
  return createComponent(Dialog, {
    ...
    get children() {
      return [(() => {
        var _el$ = _tmpl$3(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$5 = _el$2.nextSibling, _el$8 = _el$5.nextSibling;
        var _ref$ = pathArea;
        typeof _ref$ === "function" ? use(_ref$, _el$2) : pathArea = _el$2;
        insert(_el$2, createComponent(TextInputV2, {
          get value() {
            return input();
          },
          autofocus: true,
        ...
        insert(_el$3, createComponent(ButtonV2, {
          size: "small",
          variant: "ghost",
          ...
          get children() {
            ...
            insert(_el$4, createComponent(For, {
              ...
              children: (suggestion, index) => (() => {
                var _el$9 = _tmpl$4();
                _el$9.$$click = () => chooseSuggestion(suggestion);
                _el$9.$$pointermove = () => setActiveSuggestion(index());
                insert(_el$9, () => displayPickerPath(suggestion.absolute, input(), home()), null);
                insert(_el$9, () => suggestion.type === "directory" ? "/" : "", null);
                createRenderEffect((_p$) => {
                  var _v$ = `directory-picker-v2-suggestion-${index()}`, _v$2 = index() === activeSuggestion(), _v$3 = index() === activeSuggestion() ? "" : void 0;
                  _v$ !== _p$.e && setAttribute(_el$9, "id", _p$.e = _v$);
                  _v$2 !== _p$.t && setAttribute(_el$9, "aria-selected", _p$.t = _v$2);
                  _v$3 !== _p$.a && setAttribute(_el$9, "data-active", _p$.a = _v$3);
                  return _p$;
                }, {
                  e: void 0,
                  t: void 0,
        ...
        _el$5.addEventListener("wheel", (event) => {
        ...
        typeof _ref$2 === "function" ? use(_ref$2, _el$5) : container = _el$5;
        insert(_el$5, createComponent(Show, {
          ...
          get children() {
            var _el$6 = _tmpl$2();
            insert(_el$6, () => language.t("common.loading"));
            return _el$6;
          }
        }), null);
        insert(_el$5, createComponent(Show, {
          ...
          get children() {
            var _el$7 = _tmpl$2();
            insert(_el$7, () => language.t("dialog.directory.readError"));
            return _el$7;
          }
        }), null);
        insert(_el$8, () => policy.result(root(), selected(), rootValid()));
        return _el$;
...
//# sourceMappingURL=dialog-select-directory-v2-BBy1S9qU.js.map
