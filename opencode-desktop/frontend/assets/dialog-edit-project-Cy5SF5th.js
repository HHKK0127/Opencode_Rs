...
;
{
  try {
    (function() {
      ...
      n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "4ceefb35-61fe-4cf3-b430-2a547d54b7fc", e._sentryDebugIdIdentifier = "sentry-dbid-4ceefb35-61fe-4cf3-b430-2a547d54b7fc");
    })();
  } catch (e) {
  }
}
;
import { br as useDialog, bv as useGlobal, bw as useLanguage, am as createMemo, aH as getFilename, au as createStore, bA as useMutation, ad as createComponent, aL as insert, X as TextField, O as Show, ao as createRenderEffect, bc as setAttribute, A as Avatar, aR as mergeProps, aF as getAvatarColors, aI as getProjectAvatarSource, I as Icon, bn as use, h as For, a9 as classList, B as Button, aP as memo, D as Dialog, bh as template, az as delegateEvents } from "./main-D_cwiNV1.js";
  ...
  const saveMutation = useMutation(() => ({
    mutationFn: async () => {
      ...
      if (props.project.id && props.project.id !== "global") {
        ...
        serverSync().project.icon(props.project.worktree, store.iconOverride || void 0);
        dialog.close();
        return;
      }
      serverSync().project.meta(props.project.worktree, {
        name,
        icon: {
          color: store.color || void 0,
          override: store.iconOverride || void 0
        },
        commands: {
          start: start || void 0
        }
  ...
  return createComponent(Dialog, {
    ...
    get children() {
          ...
          insert(_el$14, createComponent(For, {
            ...
            children: (color) => (() => {
              ...
              _el$18.$$click = () => {
                ...
                setStore("color", store.color === color ? void 0 : color);
              };
              ...
              createRenderEffect((_p$) => {
                var _v$8 = language.t("dialog.project.edit.color.select", {
                  color
                }), _v$9 = store.color === color, _v$0 = {
                  "flex items-center justify-center size-10 p-0.5 rounded-lg overflow-hidden transition-colors cursor-default": true,
                  "bg-transparent border-2 border-icon-strong-base hover:bg-surface-base-hover": store.color === color,
                  "bg-transparent border border-transparent hover:bg-surface-base-hover hover:border-border-weak-base": store.color !== color
                };
      ...
      insert(_el$15, createComponent(Button, {
        ...
        get children() {
          return memo(() => !!saveMutation.isPending)() ? language.t("common.saving") : language.t("common.save");
        }
      }), null);
      createRenderEffect((_p$) => {
        var _v$ = {
        ...
        }, _v$2 = !!(store.iconHover && !store.iconOverride), _v$3 = !(store.iconHover && !store.iconOverride), _v$4 = !!(store.iconHover && !!store.iconOverride), _v$5 = !(store.iconHover && !!store.iconOverride);
...
//# sourceMappingURL=dialog-edit-project-Cy5SF5th.js.map
