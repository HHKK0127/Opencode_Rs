const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dialog-select-provider-bKjtPeTG.js","./main-D_cwiNV1.js","./main-CqjwCdp1.css"])))=>i.map(i=>d[i]);
!(function() {
  try {
...
;
{
  try {
    (function() {
      ...
      n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "0fc39333-2c0f-4c8b-90fc-5fe6195587f8", e._sentryDebugIdIdentifier = "sentry-dbid-0fc39333-2c0f-4c8b-90fc-5fe6195587f8");
    })();
  } catch (e) {
  }
}
;
import { bE as usePlatform, bf as splitProps, bg as spread, aR as mergeProps, aL as insert, bh as template, az as delegateEvents, br as useDialog, bM as useServerSync, bL as useServerSDK, bw as useLanguage, bG as useProviders, aY as onCleanup, am as createMemo, ap as createResource, au as createStore, ag as createEffect, ad as createComponent, s as ProviderIcon, T as Switch, M as Match, aP as memo, R as Spinner, I as Icon, ao as createRenderEffect, n as IconButton, D as Dialog, L as List, X as TextField, B as Button, aZ as onMount, b7 as produce, bd as showToast, $ as __vitePreload } from "./main-D_cwiNV1.js";
...
function DialogConnectProvider(props) {
  ...
  const all = () => {
    void __vitePreload(() => import("./dialog-select-provider-bKjtPeTG.js").then((n) => n.d), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url).then((x) => {
      ...
      insert(_el$30, createComponent(Switch, {
        get children() {
          return [createComponent(Match, {
            ...
            get children() {
              return createComponent(OAuthPromptsView, {});
            }
          }), createComponent(Match, {
            get when() {
...
//# sourceMappingURL=dialog-connect-provider-BF5IVAo-.js.map
