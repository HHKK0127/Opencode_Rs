const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-D_cwiNV1.js","./main-CqjwCdp1.css","./list-Ux16SPGo.js"])))=>i.map(i=>d[i]);
!(function() {
  try {
...
;
{
  try {
    (function() {
      ...
      n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "e0854d1e-37df-460a-b21c-858938df9b97", e._sentryDebugIdIdentifier = "sentry-dbid-e0854d1e-37df-460a-b21c-858938df9b97");
    })();
  } catch (e) {
  }
}
;
import { bE as usePlatform, bw as useLanguage, am as createMemo, bd as showToast, aL as insert, bh as template, bo as useCommand, bP as useSettings, au as createStore, aY as onCleanup, ad as createComponent, O as Show, ao as createRenderEffect, a9 as classList, aP as memo, h as For, bc as setAttribute, B as Button, I as Icon, X as TextField, n as IconButton, aE as fuzzysort, a_ as parseKeybind, aZ as onMount, aO as makeEventListener, aD as formatKeybind, aN as lazy, $ as __vitePreload, az as delegateEvents } from "./main-D_cwiNV1.js";
...
const ButtonV2 = lazy(() => __vitePreload(() => import("./main-D_cwiNV1.js").then((n) => n.a6), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({
  default: module.ButtonV2
})));
const IconV2 = lazy(() => __vitePreload(() => import("./main-D_cwiNV1.js").then((n) => n.aJ), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({
  default: module.Icon
})));
const IconButtonV2 = lazy(() => __vitePreload(() => import("./main-D_cwiNV1.js").then((n) => n.aK), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({
  default: module.IconButtonV2
})));
const TextInputV2 = lazy(() => __vitePreload(() => import("./main-D_cwiNV1.js").then((n) => n.bl), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({
  default: module.TextInputV2
})));
const SettingsListV2 = lazy(() => __vitePreload(() => import("./list-Ux16SPGo.js"), true ? __vite__mapDeps([2,0,1]) : void 0, import.meta.url).then((module) => ({
  default: module.SettingsListV2
})));
...
//# sourceMappingURL=settings-keybinds-BXGE5p-w.js.map
