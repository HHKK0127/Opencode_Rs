...
pub fn configure_api(cfg: &mut web::ServiceConfig) {
    ...
    cfg.route(
        "/global/health",
        web::get().to(super::health::global_health),
    )
    ...
    cfg.route("/session", web::get().to(super::session::list_sessions))
        ...
        .route(
            "/session/{id}/init",
            web::post().to(super::session::init_session),
        )
        .route(
            "/api/session/{id}/init",
            web::post().to(super::session::init_session),
        ...
        .route(
            "/api/session/{id}",
            web::get().to(super::session::get_session),
        )
        .route(
            "/session/{id}/abort",
            web::post().to(super::session::abort_session),
        )
        .route(
        ...
        .route(
            "/session/{id}/todo",
            web::get().to(super::session::session_todo),
        )
        .route(
            "/api/session/{id}/todo",
            web::get().to(super::session::session_todo),
        ...
        .route(
            "/session/{id}/diff",
            web::get().to(super::session::session_diff),
        )
        .route(
            "/api/session/{id}/diff",
            web::get().to(super::session::session_diff),
        ...
        .route(
            "/session/{id}/children",
            web::get().to(super::session::session_children),
        )
        .route(
    ...
    cfg.route(
        "/api/session",
        web::post().to(super::session::create_session_v2),
    )
    .route(
        "/v2/session",
        web::post().to(super::session::create_session_v2),
    ...
    .route(
        "/api/session",
        web::get().to(super::session::list_sessions_v2),
    )
    .route(
        "/v2/session",
        web::get().to(super::session::list_sessions_v2),
    ...
    .route(
        "/api/session/{id}",
        web::get().to(super::session::get_session_v2),
    )
    .route(
        "/v2/session/{id}",
        web::get().to(super::session::get_session_v2),
    ...
    .route(
        "/api/session/{id}",
        web::delete().to(super::session::delete_session_v2),
    )
    .route(
        "/v2/session/{id}",
        web::delete().to(super::session::delete_session_v2),
    ...
    .route(
        ...
        web::get().to(super::session::get_session_messages),
    )
    .route(
        "/v2/session/{id}/message",
        web::get().to(super::session::get_session_messages),
    );
    ...
    cfg.route(
        ...
        web::post().to(super::prompt::prompt_v2),
    )
    .route(
        "/v2/session/{id}/prompt",
        web::post().to(super::prompt::prompt_v2),
    );
    ...
    cfg.route(
        ...
        web::post().to(super::prompt::prompt_async_v1),
    );
    ...
    cfg.route(
        "/api/session/{id}/question",
        web::get().to(super::question::list_questions),
    )
    .route(
        "/v2/session/{id}/question",
        web::get().to(super::question::list_questions),
    )
    .route(
        "/api/session/{id}/question/{request_id}/reply",
        web::post().to(super::question::reply_question),
    )
    .route(
        "/v2/session/{id}/question/{request_id}/reply",
        web::post().to(super::question::reply_question),
    )
    .route(
        "/api/session/{id}/question/{request_id}/reject",
        web::post().to(super::question::reject_question),
    )
    .route(
        "/v2/session/{id}/question/{request_id}/reject",
        web::post().to(super::question::reject_question),
    );
    ...
    cfg.route(
        ...
        web::get().to(super::permission::list_permissions),
    )
    .route(
        "/v2/session/{id}/permission",
        web::get().to(super::permission::list_permissions),
    )
    .route(
        "/api/session/{id}/permission/{request_id}/reply",
        web::post().to(super::permission::reply_permission),
    )
    .route(
        "/v2/session/{id}/permission/{request_id}/reply",
        web::post().to(super::permission::reply_permission),
    );
    ...
    cfg.route("/provider", web::get().to(super::provider::list_providers))
        .route(
            "/api/provider",
            web::get().to(super::provider::list_providers),
        )
        .route(
            "/provider/{id}",
            web::put().to(super::provider::update_provider),
        )
        .route(
            "/api/provider/{id}",
            web::put().to(super::provider::update_provider),
        ...
        .route(
            ...
            web::get().to(super::provider::provider_oauth_authorize),
        )
        .route(
        ...
        .route(
            "/provider/auth",
            web::get().to(super::provider::provider_auth),
        )
        .route(
            "/api/provider/auth",
            web::get().to(super::provider::provider_auth),
    ...
    cfg.route(
        ...
        web::get().to(super::tools::tool_ids),
    )
    .route(
        "/experimental/tool",
        web::get().to(super::tools::list_tools),
    );
    ...
    cfg.service(
        web::scope("/api/browser")
            ...
            .route(
                "/close_session",
                web::post().to(super::browser::close_session),
            )
