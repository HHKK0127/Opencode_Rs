const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dialog-select-directory-v2-BBy1S9qU.js","./main-D_cwiNV1.js","./main-CqjwCdp1.css","./dialog-select-directory-v2-COz_lkBH.css"])))=>i.map(i=>d[i]);
!(function() {
  try {
...
;
{
  try {
    (function() {
      ...
      n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "b85ee7de-e0a2-4ac4-976c-2b766cd455c9", e._sentryDebugIdIdentifier = "sentry-dbid-b85ee7de-e0a2-4ac4-976c-2b766cd455c9");
    })();
  } catch (e) {
  }
}
;
import { bo as useCommand, bw as useLanguage, bE as usePlatform, bJ as useServer, bP as useSettings, bx as useLayout, bs as useFile, br as useDialog, bB as useNavigate, bL as useServerSDK, bM as useServerSync, bO as useSessionLayout, at as createSignal, am as createMemo, ay as decode64, aY as onCleanup, ad as createComponent, L as List, T as Switch, M as Match, aL as insert, O as Show, K as Keybind, aD as formatKeybind, I as Icon, ao as createRenderEffect, g as FileIcon, aG as getDirectory, aH as getFilename, D as Dialog, as as createSessionTabs, aN as lazy, $ as __vitePreload, a4 as base64Encode, bh as template } from "./main-D_cwiNV1.js";
...
const DialogSelectFileV2 = lazy(() => __vitePreload(() => import("./dialog-select-directory-v2-BBy1S9qU.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url).then((module) => ({
...
//# sourceMappingURL=dialog-select-file-PMM7d5_U.js.map
