const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-D_cwiNV1.js","./main-CqjwCdp1.css"])))=>i.map(i=>d[i]);
!(function() {
  try {
...
;
{
  try {
    (function() {
      ...
      n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "c46399af-9170-4aa5-8bb1-bb9ec4d85143", e._sentryDebugIdIdentifier = "sentry-dbid-c46399af-9170-4aa5-8bb1-bb9ec4d85143");
    })();
  } catch (e) {
  }
}
;
import { bQ as useSync, bv as useGlobal, bJ as useServer, bE as usePlatform, br as useDialog, bw as useLanguage, bB as useNavigate, bP as useSettings, ag as createEffect, aY as onCleanup, am as createMemo, aL as insert, ad as createComponent, V as Tabs, aP as memo, h as For, v as ServerConnection, y as ServerHealthIndicator, z as ServerRow, O as Show, I as Icon, ao as createRenderEffect, a9 as classList, bc as setAttribute, B as Button, $ as __vitePreload, au as createStore, bh as template, az as delegateEvents } from "./main-D_cwiNV1.js";
...
function StatusPopoverServerBody() {
  ...
  const sortedServers = createMemo(() => listServersByHealth(global2.servers.list(), server.key, global2.servers.health));
  ...
  const serverItems = createMemo(() => sortedServers().map((conn) => {
    ...
    return {
      key,
      conn,
      health: global2.servers.health[key],
      blocked: global2.servers.health[key]?.healthy === false,
  ...
  return createComponent(ServerStatusPopoverView, {
    get state() {
      return {
        ...
        onManage: () => {
          const run = ++dialogRun;
          void __vitePreload(() => import("./main-D_cwiNV1.js").then((n) => n.aA), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((x) => {
        ...
        return [createComponent(Tabs.List, {
          ...
          get children() {
            return [memo(() => memo(() => !!!settings.general.newLayoutDesigns())() && createComponent(Tabs.Trigger, {
              ...
              "class": "text-12-regular",
              get children() {
                return [memo(() => memo(() => global2.servers.list().length > 0)() ? `${global2.servers.list().length} ` : ""), memo(() => language.t("status.popover.tab.servers"))];
              }
...
//# sourceMappingURL=status-popover-body-BJtLc36H.js.map
